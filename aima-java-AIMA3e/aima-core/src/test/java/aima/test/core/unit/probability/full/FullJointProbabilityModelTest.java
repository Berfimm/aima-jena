...
import aima.core.probability.example.FullJointDistirubitionInfectedCoughFever;
...
public class FullJointProbabilityModelTest extends
	...
	@Test
	public void test_InfectedCoughFeverModel() {
		test_InferenceCoughFeverModel_Distributions(new FullJointDistirubitionInfectedCoughFever());
	}
