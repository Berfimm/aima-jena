...
public class ExampleRV {
	...
	public static final RandVar INFECTED_RV = new RandVar("Infected",
			new BooleanDomain());
	...
	public static final RandVar VITAMIND_RV = new RandVar("VITAMIN-LEVEL",
			new ArbitraryTokenDomain("low", "normal", "high", "very_high"));	
